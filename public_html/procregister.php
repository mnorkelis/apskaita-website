...
{ header("Location: logout.php");exit;}
  ...
  $likutis=$_POST['likutis'];$_SESSION['likutis_login']=$likutis;
		...
		{ // vardas  geras,  nuskaityti vartotoja is DB
         ...
         if ($dbuname)  {  // jau yra toks vartotojas DB
		     $_SESSION['name_error']= 
			   ...
			   $_SESSION['name_error']= "";
		       if (checkpass($pass,substr(hash('sha256',$pass),5,32))  && checkmail($mail) && checklikutis($likutis)) // antra tikrinimo dalis checkpass bus true
		 ...
		 $sql = "INSERT INTO " . TBL_USERS. " (username, password, userid, userlevel, email, likutis, timestamp)
          VALUES ('$user', '$pass', '$userid','$ulevel', '$mail', '$likutis', null)";
