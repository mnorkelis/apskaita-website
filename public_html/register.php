                           ...
                           Atgal į [<a href="index.php">Pradžia</a>]</td></tr>
                    			...
                    			<table> <tr><td>
									...
									<?php echo $_SESSION['mail_error']; ?>
                                        ...
                                        <p style="text-align:left;">Banko likutis:<br>
                                            <input class ="s1" name="likutis" type="double" value="<?php echo $_SESSION['likutis_login']; ?>"><br>
                                            <?php echo $_SESSION['likutis_error']; ?>
                                        </p>
                                        <?php
